...
The Fiberplane Console is in Open Beta, and we're actively looking for feedback on what would make it a more powerful tool for optimizing MCP servers. You can reach out in our [Discord](https://discord.com/invite/cqdY6SpfVR).
