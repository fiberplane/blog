---
title: "Cracking Open Linear's MCP Server"
...
- **Non-GraphQL functionality**: The `search_documentation` tool adds Linear's documentation to the MCP server and provides information that their core API doesn't contain.
